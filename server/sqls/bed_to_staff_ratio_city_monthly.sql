...
WITH monthly_city_base AS (SELECT a.store_feature_record_time,
...
SELECT curr.s_year                                                     AS stat_year,                  --  年
       ...
       curr.city_staff_bed_ratio                                       AS current_month_ratio,        -- 在职床位配置比
       prev.city_staff_bed_ratio                                       AS last_year_same_month_ratio, -- 上年 在职床位配置比
       ROUND(curr.city_staff_bed_ratio - prev.city_staff_bed_ratio, 2) AS yoy_diff_value,             -- 差异值
