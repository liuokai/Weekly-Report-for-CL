...
export const BusinessTargets = {
  ...
  profit: {
    ...
    budgetCostRatioTable: {
      ...
      rows: [
        { city: '四川省', hq_fee: '2.50%', masseur_cost: '44.07%', backstage_cost: '6.45%', labor_subtotal: '50.52%', rent_cost: '16.00%', depreciation_cost: '9.59%', fixed_subtotal: '25.59%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '重庆市', hq_fee: '2.50%', masseur_cost: '44.28%', backstage_cost: '6.50%', labor_subtotal: '50.79%', rent_cost: '16.59%', depreciation_cost: '8.74%', fixed_subtotal: '25.33%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '深圳市', hq_fee: '2.50%', masseur_cost: '44.68%', backstage_cost: '7.68%', labor_subtotal: '52.36%', rent_cost: '18.93%', depreciation_cost: '4.82%', fixed_subtotal: '23.75%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '杭州市', hq_fee: '2.50%', masseur_cost: '45.89%', backstage_cost: '7.76%', labor_subtotal: '53.65%', rent_cost: '16.84%', depreciation_cost: '5.63%', fixed_subtotal: '22.47%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '南京市', hq_fee: '2.50%', masseur_cost: '45.63%', backstage_cost: '7.32%', labor_subtotal: '52.95%', rent_cost: '14.94%', depreciation_cost: '8.22%', fixed_subtotal: '23.17%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '宁波市', hq_fee: '2.50%', masseur_cost: '45.24%', backstage_cost: '7.46%', labor_subtotal: '52.70%', rent_cost: '16.41%', depreciation_cost: '7.00%', fixed_subtotal: '23.41%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '广州市', hq_fee: '2.50%', masseur_cost: '45.81%', backstage_cost: '8.15%', labor_subtotal: '53.96%', rent_cost: '17.48%', depreciation_cost: '4.67%', fixed_subtotal: '22.15%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '上海市', hq_fee: '2.50%', masseur_cost: '48.61%', backstage_cost: '8.05%', labor_subtotal: '56.66%', rent_cost: '15.32%', depreciation_cost: '4.14%', fixed_subtotal: '19.46%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '北京市', hq_fee: '2.50%', masseur_cost: '48.61%', backstage_cost: '8.27%', labor_subtotal: '56.87%', rent_cost: '13.86%', depreciation_cost: '5.38%', fixed_subtotal: '19.24%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%' },
        { city: '合计', hq_fee: '2.50%', masseur_cost: '45.42%', backstage_cost: '7.25%', labor_subtotal: '52.68%', rent_cost: '16.39%', depreciation_cost: '6.82%', fixed_subtotal: '23.21%', material_cost: '6.00%', tax_cost: '1.69%', asset_maintenance: '0.50%', utility_cost: '1.20%', other_cost: '6.00%', variable_subtotal: '9.39%', profit_rate: '12.00%', isSummary: true }
      ]
    },
