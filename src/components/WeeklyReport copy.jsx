...
import UserCenterTab from "./UserCenter";
import InvestmentFinancingTab from "./InvestmentFinancing";
import SupplyChainTab from "./SupplyChain";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6 min-h-[400px]">
          ...
          {activeTab === 1 && <UserCenterTab />}
          
          {activeTab === 2 && <SupplyChainTab />}
          
          {activeTab === 3 && <InvestmentFinancingTab />}
        </div>
      </main>
    </div>
  );
